...
CREATE TABLE [dbo].[IDTABLE] (
	...
	[ID_NAME] varchar (20) COLLATE Japanese_CI_AS NULL ,
...
CREATE TABLE [dbo].[NULLABLE_DECIMAL_VERSION_NO] (
	[EMPNO] numeric (4, 0) NOT NULL ,
	[EMP_NAME] varchar(60) NULL,
	[VERSION_NO] numeric (4, 0) NOT NULL,
	CONSTRAINT [PK_NULLABLE_DECIMAL_VERSION_NO] PRIMARY KEY NONCLUSTERED ([EMPNO])
) 

CREATE TABLE [dbo].[NULLABLE_INT_VERSION_NO] (
	[EMPNO] numeric (4, 0) NOT NULL ,
	[EMP_NAME] varchar(60) NULL,
	[VERSION_NO] int NOT NULL,
	CONSTRAINT [PK_NULLABLE_INT_VERSION_NO] PRIMARY KEY NONCLUSTERED ([EMPNO])
)

CREATE TABLE [dbo].[GENERIC_NULLABLE_DECIMAL_VERSION_NO] (
	[EMPNO] numeric (4, 0) NOT NULL ,
	[EMP_NAME] varchar(60) NULL,
	[VERSION_NO] numeric (4, 0) NOT NULL,
	CONSTRAINT [PK_GENERIC_NULLABLE_DECIMAL_VERSION_NO] PRIMARY KEY NONCLUSTERED ([EMPNO])
)

CREATE TABLE [dbo].[GENERIC_NULLABLE_INT_VERSION_NO] (
	[EMPNO] numeric (4, 0) NOT NULL ,
	[EMP_NAME] varchar(60) NULL,
	[VERSION_NO] int NOT NULL,
	CONSTRAINT [PK_GENERIC_NULLABLE_INT_VERSION_NO] PRIMARY KEY NONCLUSTERED ([EMPNO])
)
...
INSERT INTO [dbo].[NULLABLE_DECIMAL_VERSION_NO] VALUES(10, "NullableDecimal", 100);
INSERT INTO [dbo].[NULLABLE_INT_VERSION_NO] VALUES(10, "NullableInt", 100);
INSERT INTO [dbo].[GENERIC_NULLABLE_DECIMAL_VERSION_NO] VALUES(10, "GenericNullableDecimal", 100);
INSERT INTO [dbo].[GENERIC_NULLABLE_INT_VERSION_NO] VALUES(10, "GenericNullableInt", 100);
