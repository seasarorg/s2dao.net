...
CREATE TABLE [dbo].[EMP_NULLABLE] (
	...
	CONSTRAINT [PK_EmployeeNullable] PRIMARY KEY CLUSTERED ([EMPNO]))
GO
...
CREATE TABLE [dbo].[UNDER_SCORE](
	...
	[TABLE_NAME] [varchar](50) COLLATE Japanese_CI_AS NULL,
	[TABLE_NAME_] [varchar](50) COLLATE Japanese_CI_AS NULL,
	[_TABLE_NAME] [varchar](50) COLLATE Japanese_CI_AS NULL,
	[_TABLE_NAME_] [varchar](50) COLLATE Japanese_CI_AS NULL,
...
INSERT INTO [dbo].[GENERIC_NULLABLE] (Date,EntityNo) VALUES(getdate(), 100)
INSERT INTO [dbo].[GENERIC_NULLABLE] (Date,EntityNo) VALUES(null, 101)
