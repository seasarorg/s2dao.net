...
{
    /// <summary>
    /// NoPersistentProps属性のサンプルを実行します。
    /// </summary>
    public class PostgreSQLNoPersistentPropsAttrClient
    {
        private const string PATH = 
            "Seasar.Dao.Examples/NoPersistentPropsAttr/PostgreSQLNoPersistentPropsAttr.dicon";
